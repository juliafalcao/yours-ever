...
def reduction_pipeline(text: str, pos_whitelist: list) -> list:
	...
	cleaned = remove_non_alphabetic(filtering) # remove remaining non-alphabetic symbols
